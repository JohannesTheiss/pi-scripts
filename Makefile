#############################################################################
# Makefile for building: helloqtquick
# Generated by qmake (3.1) (Qt 5.15.0)
# Project:  helloqtquick.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile helloqtquick.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = helloqtquick1.0.0
DISTDIR = /run/media/johannes/Alles/Code/C++/Qt_tutorial/.tmp/helloqtquick1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		helloqtquick.pro  main.cpp
QMAKE_TARGET  = helloqtquick
DESTDIR       = 
TARGET        = helloqtquick
...
helloqtquick:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: helloqtquick.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		helloqtquick.pro
	$(QMAKE) -o Makefile helloqtquick.pro
